...
using Stroll.History.Market.Services;
using System.Text.Json;

namespace Stroll.History.Market;

/// <summary>
/// Stroll History Market Service
/// 
/// High-performance market history data access for backtesting and strategy development.
...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        try
        {
            ...
            logger.LogInformation("🚀 Stroll History Market Service starting...");
